...
// antenna on, no go and bars
  const uint8_t ant_L[] PROGMEM = {0xff,0x81, 0x41,0x21,0x11,0x09,0x05,0x03,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01}; 
  const uint8_t ant_R[] PROGMEM = {0xfe,0x02,0x04,0x08,0x10,0x20,0x40,0x80,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0};

  const uint8_t X_L[] PROGMEM = {0x80, 0x40,0x20,0x10,0x08,0x04,0x02,0x01,0x02,0x04,0x08,0x10,0x20,0x40,0x80,0x0};
  const uint8_t X_R[] PROGMEM = {0x02,0x04,0x08,0x10,0x20,0x40,0x80,0x0,0x80,0x40,0x20,0x10,0x08,0x04,0x02,0x00};

  const uint8_t bars_L[] PROGMEM = {0,0,0,0,0,0,0,7,7,7,0x77,0x77,0x77,0x77,0x77,0x77};
  const uint8_t bars_R[] PROGMEM = {7,7,7,7,0x77,0x77,0x77,0x77,0x77,0x77,0x77,0x77,0x77,0x77,0x77, 0x77};
